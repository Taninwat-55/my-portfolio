...
### Phase 1: The Initiative Gap (Operations Assistant)
...
### Phase 2: Structuring the Chaos (Operations Manager)

That initiative led to my first promotion. As Operations Manager, my problem shifted from "What do I do?" to "How do we work?"
...
**The Result:** Coordination delays dropped noticeably, and the hybrid model was adopted org-wide.

### Phase 3: Head of Organization
...
Keeping students engaged and motivated across the organization was a delicate balance. I focused on **enablement**: facilitating workshops to unblock teams rather than micromanaging them.
...
- Across four cycles, we supported **75+ students** on around **20 client projects**.
