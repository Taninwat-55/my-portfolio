...
When I built [Satoshi Standard](/cases/satoshi), I tried to solve one small part of this problem: **making Bitcoin amounts feel understandable.**
...
This is a simple product decision. But it changes how people think about Bitcoin. Don't take my word for it. Try it yourself:

<SatsConverter />

Type a coffee's worth of sats and watch the dollar amount land in your head differently than the BTC fraction would. That's the whole product thesis in one widget.
