...
readTime: "5 min read"
excerpt: "Most developers optimize for code quality. I optimize for conversion. Here is why web performance is actually a business problem."
---

Opportunity cost is a core business idea. In frontend, we call it **latency**. They are the same thing.
...
3.  **Does the "weight" of this feature justify the "wait" for the user?** (Business Impact)
